...
PARAM  <- list()
PARAM$experimento <- "TS93143"

PARAM$exp_input  <- "FE92542"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(201901,201902,201903,201904,201905,201906,201907,201908,201909,201910,201911,201912,202011,202012,202101,202102,202103,202104,202105,202106,202107)
