...
PARAM  <- list()
PARAM$experimento <- "TS93150"

PARAM$exp_input  <- "FE92542"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(202012,202011,202102,202101,202103,201905,201906,201907,201908,201909,201910,201911,201912,202104,202105,202106,202107)

PARAM$train$training     <- c(202012,202011,202102,202101,202103,201905,201906,201907,201908,201909,201910,201911,201912,202104,202105)
